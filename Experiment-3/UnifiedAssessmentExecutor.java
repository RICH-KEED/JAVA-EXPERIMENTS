...
public class UnifiedAssessmentExecutor extends AbstractAssessmentFlow 
    ...
    public UnifiedAssessmentExecutor(boolean isProctored, String studentId, 
                                   String courseCode, String assessmentType) {
    ...
    public static void main(String[] args) {
        ...
        UnifiedAssessmentExecutor autoQuiz = new UnifiedAssessmentExecutor(
            false, "24BCS10039", "CS401", "Online Quiz"
        );
        autoQuiz.executeAssessment();
        
        System.out.println("\nTest 2: Final Exam");
        UnifiedAssessmentExecutor proctoredExam = new UnifiedAssessmentExecutor(
            true, "24BCS10039", "JAVA201", "EST Exam"
        );
